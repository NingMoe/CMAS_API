...
///////////////////////////////////////////////////////////
	...
	//        byte[] outucStatusCode=new byte[2];//[2];
      ...
      String bTMSerialNumber =String.format("%06d",Integer.parseInt(inTMSerialNumber )); //�׺ݾ�(TM)����Ǹ�  
  
       System.arraycopy(  bTMSerialNumber.getBytes(),0,CMDDATA,offset,6);
       offset+=6;
       
        inTMAgentNumber =String.format("%04d",Integer.parseInt(inTMAgentNumber)); //���ȭ��N��
       System.arraycopy(inTMAgentNumber.getBytes(),0,CMDDATA,offset,4);
       offset+=4;
       
       SimpleDateFormat fdate =   new SimpleDateFormat ("");//�׺ݾ�����ɶ�
       ...
       byte[] bCPULocationIDbyte =String.format("%02d",Integer.parseInt(  inCPULocationID)).getBytes();//�G�N�����q�N�� 
       
     //  byte[] chars =  sys.GetNodeValue("MERCHANT","NewLocationID").getBytes();
       inLocationID =Integer.toHexString((int) bCPULocationIDbyte[0]);//�@�N�����q�N��
...
public class V2Command{
    ...
    private SerialPort serialPort;    
     ...
     public void SetReaderparameter(String stcode,String marchant_location,String merchant_id,String tmid,String tm_agentnumber,String tm_serialno,Date DateTime)
     {
        ...
        Merchant_STCODE=new String(stcode);//�����N��
		Merchant_LocationID=new String(marchant_location);//�����q�N�X
        TM_ID=new String(tmid);//����
  		TM_SerialNo=new String(tm_serialno);//
        TM_AgentNumber=new String(tm_agentnumber);//�����N��
        Transtime=DateTime;
        return ;
     }
     */
