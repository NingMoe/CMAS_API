...
public class SSLNoCA {
	
	static Logger logger = Logger.getLogger(SSLNoCA.class);
	...
	public SSLNoCA(String url, int port, String certFilePath) {
		mUrl = url;
		mPort = port;
	...
	private KeyStore getKeyStore() throws KeyStoreException,
		...
		InputStream fKeyStore = SSLNoCA.class.getClassLoader().getResourceAsStream(scCertFilePath);
